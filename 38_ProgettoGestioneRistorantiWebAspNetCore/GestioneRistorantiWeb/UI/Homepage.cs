...
namespace UI
{
    public partial class Homepage : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            chart2.Series["Serie1"].Points.AddXY("Trimestre 1", numPrenotazioni1);
            chart2.Series["Serie1"].Points.AddXY("Trimestre 2", numPrenotazioni2);
            chart2.Series["Serie1"].Points.AddXY("Trimestre 3", numPrenotazioni3);
            chart2.Series["Serie1"].Points.AddXY("Trimestre 4", numPrenotazioni4);
